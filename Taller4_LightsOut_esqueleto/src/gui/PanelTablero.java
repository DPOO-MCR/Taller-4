...
public class PanelTablero extends JPanel{
	...
	public PanelTablero (int TAMANO_TABLERO, int TAMANO_CELDA, Tablero tablero) {
	...
	public void setTAMANO_TABLERO (int tamaño) {
		this.TAMANO_TABLERO=tamaño;
	}
	
	public void setTAMANO_CELDA (int tamaño) {
		this.TAMANO_CELDA=tamaño;
	}
